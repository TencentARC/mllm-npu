...
class ResamplerXL(nn.Module):
    ...
    def forward(self, x):
        ...
        encoder_hidden_1 = self.unet_proj_1(hidden_embeds)
        encoder_hidden_2 = self.unet_proj_2(hidden_embeds)
        prompt_embeds = torch.cat([encoder_hidden_1, encoder_hidden_2], dim=-1)
        pooled_prompt_embeds = self.unet_attnpool(hidden_embeds)
