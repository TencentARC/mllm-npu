...
from diffusers import StableDiffusionPipeline, StableDiffusionXLPipeline, StableDiffusionXLInstructPix2PixPipeline, \
...
if is_torch2_available():
    from mllm_npu.models.generation.attention_processor import IPAttnProcessor2_0 as IPAttnProcessor, \
        AttnProcessor2_0 as AttnProcessor
else:
    from mllm_npu.models.generation.attention_processor import IPAttnProcessor, AttnProcessor
...
class SDXLAdapter(nn.Module):
    ...
    @torch.inference_mode()
    def get_image_embeds(self, image_pil=None, image_tensor=None, image_embeds=None, return_negative=True,
                         image_size=448):
        ...
        if image_tensor is not None:
            ...
            image_tensor_neg = torch.zeros(1, 3, image_size, image_size).to(image_embeds.device,
                                                                            dtype=image_embeds.dtype)
