...
from transformers.optimization import (
    ...
    get_polynomial_decay_schedule_with_warmup, get_constant_schedule,
    get_constant_schedule_with_warmup, get_inverse_sqrt_schedule,
...
def _get_cosine_schedule_with_warmup_lr_lambda(current_step: int,
    ...
    return max(
        0.0, 0.5 * ((1.0 + min_lr_ratio) + (1.0 - min_lr_ratio) *
